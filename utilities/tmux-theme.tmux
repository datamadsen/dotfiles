...
set "status-right" "#[fg=$black,bg=$green,nounderscore,noitalics]  ${date_format}  ${time_format}  "
...
set "window-status-current-format" "#[fg=$white,bg=$visual_grey,bold]  #I: #W #{?window_zoomed_flag,* ,}"
